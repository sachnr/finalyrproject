...
PMA_commonParams.setAll({common_query:"",opendb_url:"db_structure.php",lang:"en",server:"1",table:"",db:"",token:"Gb0&[*-YIxF^p35M",text_dir:"ltr",show_databases_navigation_as_tree:true,pma_text_default_tab:"Browse",pma_text_left_default_tab:"Structure",pma_text_left_default_tab2:false,LimitChars:"50",pftext:"P",confirm:true,LoginCookieValidity:"1440",session_gc_maxlifetime:"1440",logged_in:true,is_https:false,rootPath:"/phpmyadmin/",arg_separator:"&",PMA_VERSION:"4.9.0.1",auth_type:"cookie",user:"root"});
...
<span id="page_nav_icons"><span id="lock_page_icon"></span><span id="page_settings_icon"><img src="themes/dot.gif" title="Page-related settings" alt="Page-related settings" class="icon ic_s_cog" /></span><a id="goto_pagetop" href="#"><img src="themes/dot.gif" title="Click on the bar to scroll to top of page" alt="Click on the bar to scroll to top of page" class="icon ic_s_top" /></a></span><div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="loginerp" targettable="user_info">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `user_info`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="loginerp" targettable="user_info">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `user_info`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="loginerp" targettable="images">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `images` (`id`, `name`) VALUES (&#039;sachnr&#039;, &#039;uploads/sachnr.jpg&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="loginerp" targettable="images">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">DELETE FROM `images` WHERE id=&quot;sachnr&quot;&amp;name=&quot;sachnr.jpg&quot;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="loginerp" targettable="images">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">DELETE FROM `images` WHERE id=&#039;sachnr&#039;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="loginerp" targettable="images">
                            <div class="action_content">
